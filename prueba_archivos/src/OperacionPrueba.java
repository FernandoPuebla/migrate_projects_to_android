...
public class OperacionPrueba {
    public static void main(String[] args) {
        ...
        for (Estudiante estudiante:(ArrayList<Estudiante>) listaLeida) {
            System.out.println(estudiante.getCedula() + " " + estudiante.getNombre() + " " + estudiante.getApellidos()
